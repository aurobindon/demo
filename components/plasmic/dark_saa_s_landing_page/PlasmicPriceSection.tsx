...
import sty from "./PlasmicPriceSection.module.css"; // plasmic-import: tk5Gztdy_wRl/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___3Rwpg)}
      >
        <div className={classNames(projectcss.all, sty.freeBox__edWqs)}>
          <PriceCard
            borders={["flatLeft"]}
            className={classNames("__wab_instance", sty.priceCard__yt1Po)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox___6V4AG)}>
          <div className={classNames(projectcss.all, sty.freeBox___43Yx)}>
            <div
          ...
          <PriceCard
            borders={["flatCenter"]}
            className={classNames("__wab_instance", sty.priceCard__wrF3V)}
          />
        </div>
        <div className={classNames(projectcss.all, sty.freeBox__ivRnP)}>
          <PriceCard
            borders={
            ...
            className={classNames("__wab_instance", sty.priceCard__jCk8S)}
          />
        </div>
      </Stack__>
    </div>
